        ...
        <>
            <div className='m-6'>
                <div>
                    {/* user image collage */}
                    {/* <Image width={300}
                    height={300} className="h-auto max-w-lg rounded-lg" src="" alt="Profile Image" /> */}
                ...
                <div>
                    <form className='m-4'>
                        <div className="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last seen location</label>
                            ...
                            <div>
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Missing Date</label>
                                <input type="date" id="missing_date" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="123-45-678" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required />
                            </div>
